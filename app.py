...
openai.api_key = st.secrets.get("openai_api_key", "")  # Use get to prevent crash if not set

def ask_gpt(prompt):
    if not openai.api_key:
        return "❌ Error: OpenAI API key not found. Please configure it in Streamlit secrets."
    try:
